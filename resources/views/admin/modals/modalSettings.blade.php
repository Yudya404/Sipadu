					...
					<div class="card-body">
						<form id="userFormEdit" method="POST" action="" enctype="multipart/form-data">
							<div class="row g-5">
								...
								<div class="col-lg-6">
									<div class="mb-5">
										...
										<select id="jabatanSelect" class="form-select form-select-solid" data-control="select2" data-allow-clear="true" data-placeholder="Pilih Jabatan">
							...
							<div class="modal-footer">
								<button type="button" id="saSimpanEditUser" class="btn btn-primary">Simpan</button>
							</div>	
						</form>
					</div>
				</div>

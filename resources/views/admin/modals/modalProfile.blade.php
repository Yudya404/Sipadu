				...
				<div class="card-body row">
					<div class="col-lg-6 d-flex flex-column">
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">2131312131313</label>
								</div>
							</div>
						</div>
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">Andi Sutanto</label>
								</div>
							</div>
						</div>
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">08623237233</label>
								</div>
							</div>
						</div>
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">andi@gmail.com</label>
								</div>
							</div>
						</div>
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">Jl. Imam Bonjol No. 1</label>
								</div>
							</div>
						</div>
						<div class="row g-5">
							<div class="col-lg-6">
								<div class="mb-5">
									<label for="exampleFormControlInput1" class="form-label fs-5">Jenis Kelamin</label>
								</div>
							</div>
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">Laki-Laki</label>
								</div>
							</div>
						</div>
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">13 Januari 2025</span></label>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-6 d-flex flex-column">
						...
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">Kepala Daerah</label>
								</div>
							</div>
						</div>
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5"><span class="badge badge-success">Super User</label>
								</div>
							</div>
						</div>
						<div class="row g-5">
							...
							<div class="col-lg-6">
								<div>:
									<label for="exampleFormControlInput1" class="form-label fs-5">12 Februari 2025</label>
								</div>
							</div>
						</div>
					</div>
